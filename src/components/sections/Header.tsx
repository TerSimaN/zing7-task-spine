...
const Header = () => {
  return (
    <header className="container flex flex-col items-center pt-[3.75rem] lg:pb-[3.75rem] pb-5">
      <div className="flex flex-col items-center space-y-10 lg:px-0 px-6 lg:-mb-[5.5rem] max-w-2xl">
        <div className="flex flex-col space-y-8">
          <h1 className="font-sf-pro font-bold lg:text-web-display-1 text-display-1 text-spine-neutral-800 text-center">
